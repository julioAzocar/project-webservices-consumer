...
public class EmpleadoWSClient {
	...
	private static String urlAWS = "http://projectwebservice-env.eba-wi8swgqt.us-east-1.elasticbeanstalk.com/devpredator/empleadosWS";

	///devpredator/empleadosWS/buscarEmpleadoPorId/1
	
	private static String urlLOCAL="http://localhost:8080/project-webservice/devpredator/empleadosWS";
